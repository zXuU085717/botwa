...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["Bug Simple 4ksanzz", "Dekstop", "3.0"]})
console.log(color('[ Base Ori 4ksanzz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : 4ksanzz-MD\n➸ Creator : 4ksanzz\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : 4ksanzz`\n➸ My Instagram : @fhl.dx17\n➸ My Github : 4ksanzz\n\nDonase Me For Support :\n➸ Dana : 087846332111\n➸ Shopeepay : 087846332111\n➸ Gopay : 087846332111\n➸ Ovo : 087846332111\n\nThanks\n', 'red'))
